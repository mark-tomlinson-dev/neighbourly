	...
	return (
		<div className={styles.about}>
            ...
            <div className={styles.aboutText}>
              <p>The fight against COVID-19 depends on each of us doing the right thing. But in isolation it can be hard to see or feel the good we’re doing. Neighbourly is designed to change that. Through the simple daily click of a button, users can let their neighbours know that they’re acting to protect the community. By visiting the page, they can easily visualise, and be inspired by, the effort of those around them. <span>This project was inspired by the ABC's 7.30 Report. <a target="_blank" href="https://www.youtube.com/watch?v=dJ1l5pGbFw0" alt="7.30 report video about how to stop the spread of covid-19">Watch the video here.</a></span>
              </p>
						</div>
					</div>
